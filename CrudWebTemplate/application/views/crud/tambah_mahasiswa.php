<!--membuat tampilan input / tambah user-->
<div class="row">
<div class="col-lg-7"> 
<div class="p-5"> 
<div class="text-center"> 
<h1 class="h4 text-gray-900 mb-4">Tambah User</h1></div>
<form class="user" action="<?php echo base_url('Mahasiswa/input');?>" method="post"><!--base urlnya-->
...
<input type="submit" class="btn btn-success btn-icon-split" name="submit" value="Tambah"><!--untuk menambahkan button-->
</form><hr> 
<div class="text-center"> <!--untuk mengatur posisi text-->
